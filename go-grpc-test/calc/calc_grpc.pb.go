...
type CalculatorClient interface {
	Sum(ctx context.Context, in *Numbers, opts ...grpc.CallOption) (*Number, error)
}
...
func (c *calculatorClient) Sum(ctx context.Context, in *Numbers, opts ...grpc.CallOption) (*Number, error) {
	out := new(Number)
...
type CalculatorServer interface {
	Sum(context.Context, *Numbers) (*Number, error)
...
func (UnimplementedCalculatorServer) Sum(context.Context, *Numbers) (*Number, error) {
